                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <form action="{{route('package.show')}}" method="post">
                                        ...
                                        <button type="submit"
                                            class="p-0 text-md btn-rounded text-primary border-0 bg-transparent" title="details">
                                            <i class="fa fa-bars"></i>
                                        </button>
                                    </form>
                                </td>
                                <td class="text-center">
                                    <button  class="p-0 text-md btn-rounded text-danger border-0 bg-transparent" title="delete">
