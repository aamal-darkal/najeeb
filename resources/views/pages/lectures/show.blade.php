    ...
    <div class="padding">
                <div class="row">
                    <div class="col">
                        <div class="box p-a">
                            <div class="item">
                                <div class="item-overlay h4 active p-a">
                                    <p class="pull-left text-u-c label label-md primary">Lecture</p>
                                </div>
                            </div>
                            <div class="p-a">
                                        ...
                                        @foreach($lecture->pdfFiles as $file)
                                            <tr>
                                                ...
                                                <td class="h4">
                                                    ...
                                                    <a href="{{route('delete.subject',$file->id)}}"
                                                       class=" m-b-sm w-xs"><i class="fa fa-trash text-danger"></i></a>
