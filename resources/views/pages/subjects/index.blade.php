...
{{--        }"--}}
                    ...
                    @foreach($subjects as $subject)
                        <tr>
                            ...
                            @if($subject->package)
                            <td class="text-center"><span class="label primary pos-rlt" style="font-size: 100%"> {{$subject->package->name}}</span>
                            </td>
                            @else
                                <td></td>
                            @endif
                            <td >
                                <button  class="p-0 text-md btn-rounded text-danger text-md border-0 bg-transparent" title="delete">
