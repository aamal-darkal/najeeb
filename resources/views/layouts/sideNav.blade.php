...
{{--                      <span ui-include="'../assets/images/i_0.svg'"></span>--}}
                  ...
                  <span class="nav-caret">
                    ...
                    @endif
                    @if(Route::has('Broadcast.notification'))
                                <li>
                                    <a>
                  <span class="nav-caret">
                    <i class="fa fa-caret-down"></i>
                    ...
                    <i class="material-icons">&#xe7f7;
                      <span ui-include="'../assets/images/i_1.svg'"></span>
                                    ...
                                    <ul class="nav-sub">
                                        <li>
                                            <a href="{{route('Broadcast.notification')}}">
                                                <span class="nav-text">Broadcast</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{route('send.user.notification')}}">
                    ...
                    <div id="table_data" class="table-responsive" style="height: 150px">
                        <table class="table table-striped b-t">
                            ...
                            @foreach($packages as $package)
                                <tr>
                                    <td><label class="ui-check m-0"><input type="radio" id="id" name="id"
                                                                           value="{{$package->id}}" required><i
